 ...
 * `fakeLoadBookFile`), the same substitution technique the Preview coalescing
 * session already established as legitimate for proving this exact class of ordering
